# Checklist quotidienne d'acquisition
...
- [ ] Téléphone chargé, écouteurs connectés
- [ ] Chronomètre visible (pour tracker durée des appels)
...
- [ ] One-pager Clenar imprimé
- [ ] Calendly QR code imprimé
- [ ] Batterie externe
- [ ] Itinéraire Google Maps préparé avec 10-15 adresses
- [ ] Tenue professionnelle mais accessible

---

## Pendant la Session

### Cold Calls (Bloc 2h = ~25-30 appels)

**Rythme** : 1 appel toutes les 4-5 minutes (appel + notes)

- [ ] Lancer l'enregistrement
- [ ] Appeler depuis Twenty (clic sur le numéro)
- [ ] Utiliser script approprié selon l'industrie (Platten ou Daniel G)
- [ ] Après CHAQUE appel :
  - [ ] Logger outcome dans Twenty (Connecté Y/N, Intéressé Y/N, Démo Bookée Y/N)
  - [ ] Noter objection principale si refus
  - [ ] Ajouter note rapide sur réaction du prospect
  - [ ] Déplacer la carte dans le pipeline Twenty

**Pause toutes les 10 appels** (5 min) : boire, étirer, réinitialiser l'énergie

---

### Guerrilla (Bloc 3-4h = 10-15 visites)

**Rythme** : 1 visite toutes les 15-20 minutes (visite + trajet + logging)

- [ ] Arriver, respirer, entrer avec confiance
- [ ] Exécuter : Entrée → Pitch → Démo Live
- [ ] Après CHAQUE visite, avant de démarrer la voiture :
  - [ ] Logger dans Twenty : nom, personne rencontrée, réaction, outcome
  - [ ] Si démo bookée : envoyer confirmation SMS immédiatement
  - [ ] Noter prochaine action (follow-up, retour à faire, etc.)

**Pause lunch** (1h) : recharger, review des 5 premières visites
...
- [ ] Ou manuellement : noter dans un doc les chiffres clés
  ...
  - Visites faites / Conversations complètes / Démos bookées
...
- [ ] Analyse approfondie de la semaine :
  ...
  - [ ] Scripts qui performent le mieux
- [ ] Créer document de learnings (insights à retenir)
- [ ] Ajuster stratégie pour la semaine suivante
- [ ] Célébrer les wins (démos bookées, closes, feedbacks positifs)
...
**Ne juge pas les résultats avant 50 contacts.** Les premiers appels/visites sont toujours awkward. C'est normal. Tu affines en marchant.

**Consistency > Intensity.** Mieux vaut 20 appels par jour pendant 5 jours (100 total) que 100 appels en un jour puis burnout.

---

## Success Looks Like (Semaine 1)

- [ ] 50+ cold calls loggés dans Twenty
- [ ] 10+ visites guerrilla loggées dans Twenty
- [ ] 3-5 démos bookées (tous canaux confondus)
- [ ] 5-10 enregistrements d'appels analysés
- [ ] Document "Learnings Week 1" créé avec patterns identifiés
- [ ] Énergie maintenue (pas de burnout)

Si tu coches ces cases en Semaine 1, tu es sur la bonne trajectoire pour identifier le playbook gagnant.