...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-slate-50 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-neutral-900 max-w-4xl font-bold tracking-tight">
          Changelog de l'aventure
        </h2>
        <p className="text-neutral-600 text-sm md:text-base max-w-sm">
          Découvrez l'évolution de Cofounder et les dernières fonctionnalités ajoutées pour vous aider à construire votre produit.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white flex items-center justify-center shadow-sm border border-neutral-200">
