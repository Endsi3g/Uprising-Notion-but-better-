...
export class ConfigVariables {
  ...
  DEFAULT_AI_SPEED_MODEL_ID =
    'llama3.1,gpt-4.1-mini,claude-haiku-4-5-20251001,grok-3-mini';
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.OTHER,
    isSensitive: true,
    description: 'Authentication token for Browserless instance (optional)',
    type: ConfigVariableType.STRING,
  })
  @IsOptional()
